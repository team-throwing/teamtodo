...
/**
 * todo_ 테이블에 대한 CRUD 작업을 수행하는 DAO 입니다.
...
public interface TodoDao {
     ...
     * DB에 할 일 저장
     * @param todo
     * @return 저장 성공: 자동 생성 키를 포함하는 새 {@link Todo} 객체를 가지는 Optinoal <br/>
     *          저장 실패: Optional.empty()
     * @throws SQLException
     * @throws SQLTimeoutException
     * @implNote <br>
     * <ul>
     *     <li>파라마터로 전달받은 todo의 id 필드는 사용하지 마세요.</li>
    ...
    /**
     * 할일 수정
     * @param todo 반드시 id 를 포함하고 있어야 함
     * @return 수정 성공 여부(수정할 할일을 찾지 못한 경우 false)
     * @throws SQLException
     * @throws SQLTimeoutException
     * @implNote 파라미터로 전달받은 할일 의 id 초기화 여부를 반드시 검증해야 합니다.
     */
